...
export const projectsData: IProject[] = [
  ...
  },
  {
    ...
    technologyDescription: [
      ...
      '- используется Context. Для оптимизации используются 2 контекста: для данных и отдельно для функций.',
