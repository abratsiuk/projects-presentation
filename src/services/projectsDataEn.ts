...
export const projectsData: IProject[] = [
  {
    ...
    shortDescription: 'React Redux store',
    fullDescription: [
  ...
  },
  {
    ...
    name: 'Backend Test (ASP.NET Core, EF Core)',
    shortDescription:
      'REST API for employee management: CRUD operations, pagination, filtering and basic validation.',
    fullDescription: [
      'Backend for the employee list and CRUD in Angular 9 / 20.',
      'Pagination and filtering have been added. CRUD operations implemented.',
    ],
    technology: [],
    technologyAdditional: [],
    comment: '',
  ...
  },
  {
    ...
    images: [
      'images/projects/an9_employee_01.png',
      'images/projects/an9_employee_02.png',
      'images/projects/an9_employee_03.png',
    ],
    nameShort: 'Angular 9 CRUD',
    name: 'Angular 9 CRUD',
    shortDescription: 'Employee list and CRUD in Angular 9',
    fullDescription: [
